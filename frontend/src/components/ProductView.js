...
const ProductDetails = () => {
  ...
  useEffect(() => {
    async function fetchProductDetails() {
      try {
        const response = await fetch(`https://charme-6463739a607a.herokuapp.com/products?id=${id}`, {
          method: 'GET',
        ...
        {product ? (
          ...
          <div className="product">
            <div className="product-photo">
              <img src={'https://charme-6463739a607a.herokuapp.com/products/image?id=' + product.id + '&n=1'} alt={product.name} />
              <img src={'https://charme-6463739a607a.herokuapp.com/products/image?id=' + product.id + '&n=2'} alt={product.name} />
            </div>
